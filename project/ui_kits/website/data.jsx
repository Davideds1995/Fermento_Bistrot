/* ============================================================
   ...
   Static sample data. Backend (Supabase) wired later.
   ============================================================ */

window.FERMENTO_COPY = {
...
window.FERMENTO_PRODUCTS = window.FERMENTO_MENU.flatMap(cat =>
  cat.items.map(it => ({ ...it, category: cat.name, categoryId: cat.id }))
);

/* ---- Sample reservations for /admin ---- */
window.FERMENTO_RESERVATIONS = [
